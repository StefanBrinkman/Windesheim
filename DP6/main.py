...
def main():
    ...
    recept1.voeg_ingredient_toe(Ingredient("1 grote ui", 200, "gram", 50))
    recept1.voeg_ingredient_toe(Ingredient("2 teenjes knoflook", 100, "gram", 30))
    recept1.voeg_ingredient_toe(Ingredient("1 rode paprika", 100, "gram", 20))
    recept1.voeg_ingredient_toe(Ingredient("1 groene paprika", 100, "gram", 20))
    recept1.voeg_ingredient_toe(Ingredient("Olijfolie", 200, "gram", 80))
    ...
    recept1.voeg_stap_toe(Stap("Bak de ui en knoflook glazig in een pan met olijfolie. Doe de blokjes kipfilet erbij. Bak het rondom mee zodat de buitenkant van de kip alvast aangebakken is. Doe de reepjes paprika er ook bij en bak dit mee."))
    recept1.voeg_stap_toe(Stap("Voeg de kruiden (kerriepoeder, kurkuma en sambal) bij het kipmengsel, roer dit goed door en laat even meebakken. Voeg het water met het bouillonblokjes samen met het sap van de ananas toe en verwarm dit ongeveer 8 minuutjes mee."))
    recept1.voeg_stap_toe(Stap("Meng maizena met een beetje koud water in een kommetje en roer dit goed door elkaar. Voeg dit bij de saus en verwarm het een paar minuutjes mee zodat de saus kan binden."))
    recept1.voeg_stap_toe(Stap("Proef de saus en voeg eventueel een beetje zout toe.Voeg de ananas en crème fraîche toe en verwarm even mee."))
    recept1.voeg_stap_toe(Stap("Serveer de kip kerrie met gekookte rijst."))
    ...
    recept2.voeg_ingredient_toe(Ingredient("5 plakjes bladerdeeg", 450, "gram", 150))
    recept2.voeg_ingredient_toe(Ingredient("1 grote ui", 200, "gram", 50))
    recept2.voeg_ingredient_toe(Ingredient("1 rode paprika", 100, "gram", 20))
    recept2.voeg_ingredient_toe(Ingredient("2 teenjes knoflook", 100, "gram", 30))
    recept2.voeg_ingredient_toe(Ingredient("4 eieren", 200, "gram", 400))
    recept2.voeg_stap_toe(Stap("Warm oven voor op 180 graden"))
    recept2.voeg_stap_toe(Stap("Maak een vorm met bladerdeeg"))
    recept2.voeg_stap_toe(Stap("Snij de ui en knoflook fijn"))
    recept2.voeg_stap_toe(Stap("Snij de paprika in stukjes"))
    recept2.voeg_stap_toe(Stap("Voeg klein beetje olie toe en bak de ui, paprika en knoflook"))
    recept2.voeg_stap_toe(Stap("Voeg gehakt, kruiden, zout en peper toe"))
    recept2.voeg_stap_toe(Stap("Breng het al mengent op temperatuur en voeg zo nodig kruiden toe.", "Meng alles in 1 keer"))
    recept2.voeg_stap_toe(Stap("Meng de eieren"))
    recept2.voeg_stap_toe(Stap("Bak het 35-45 minuten in de over totdat het gaar is."))
    ...
    recept3.voeg_ingredient_toe(Ingredient("1 teen knoflook", 50, "gram", 15))
    recept3.voeg_ingredient_toe(Ingredient("1 grote ui", 200, "gram", 50))
    recept3.voeg_ingredient_toe(Ingredient("Ketchup", 100, "gram", 200))
    recept3.voeg_ingredient_toe(Ingredient("1 eetlepel sojasaus", 120, "gram", 65))
    ...
    recept3.voeg_stap_toe(Stap("Voeg dan de overige ingrediënten toe en kook de saus in."))
    recept3.voeg_stap_toe(Stap("Kook de saus iets in tot het de dikte heeft van chilisaus"))
